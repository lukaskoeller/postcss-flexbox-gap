...
describe('CSS Flexbox Gap Polyfill', () => {
  it('should fallback when gap and display: flex are defined in a single selector', async () => {
    await run(
      ...
      '.some { color: red; } .single { --gap: 24px; display: flex; gap: var(--gap);--pfg-gap: var(--gap); } .single > * + * { margin-left: var(--pfg-gap, 0); } .single { column-gap: 0; grid-column-gap: 0; }',
      { }
    )
  });
  it('should fallback when gap and display: flex are defined in multiple selectors', async () => {
    await run(
      ...
      '.some { color: red; } .first { --gap: 24px; gap: var(--gap);--pfg-gap: var(--gap); } .second { display: flex; } .second > * + * { margin-left: var(--pfg-gap, 0); } .second { column-gap: 0; grid-column-gap: 0; }',
      { }
    )
  });
  it('should fallback when gap-column is used', async () => {
    await run(
      ...
      '.some { color: red; } .first { --gap: 24px; column-gap: var(--gap);--pfg-gap: var(--gap); } .second { display: flex; } .second > * + * { margin-left: var(--pfg-gap, 0); } .second { column-gap: 0; grid-column-gap: 0; }',
      { }
    )
  });
  it('should fallback when grid-gap is used', async () => {
    await run(
      ...
      '.some { color: red; } .first { --gap: 24px; grid-gap: var(--gap);--pfg-gap: var(--gap); } .second { display: flex; } .second > * + * { margin-left: var(--pfg-gap, 0); } .second { column-gap: 0; grid-column-gap: 0; }',
      { }
    )
  });
  it('should fallback when grid-column-gap is used', async () => {
    await run(
      ...
      '.some { color: red; } .first { --gap: 24px; grid-column-gap: var(--gap);--pfg-gap: var(--gap); } .second { display: flex; } .second > * + * { margin-left: var(--pfg-gap, 0); } .second { column-gap: 0; grid-column-gap: 0; }',
      { }
    )
  });
  it('should omit gap when used in conjuction with display: grid', async () => {
    await run(
      ...
      '.some { color: red; } .first { --gap: 24px; grid-gap: var(--gap); display: grid; } .second { display: flex; } .second > * + * { margin-left: var(--pfg-gap, 0); } .second { column-gap: 0; grid-column-gap: 0; }',
      { }
    )
  });
  ...
  it('should omit when flexbox wrap is used', async () => {
    await run(
      ...
      '.some { color: red; } .first { flex-flow: row wrap; gap: 20px; } .second { display: flex; } .second > * + * { margin-left: var(--pfg-gap, 0); } .second { column-gap: 0; grid-column-gap: 0; }',
      { }
    )
  });
